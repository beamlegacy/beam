//
//  BidirectionalPopoverBlockItem.swift
//  Beam
//
...
class BidirectionalPopoverBlockItem: BidirectionalPopoverItem {

    static let identifier = NSUserInterfaceItemIdentifier("BidirectionalPopoverBlockItem")
