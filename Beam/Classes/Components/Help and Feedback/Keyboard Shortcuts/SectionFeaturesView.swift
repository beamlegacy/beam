    ...
    var features: [KeyboardFeature] {
        ...
        case .browser:
            return [KeyboardFeature(name: "Collect the Web", shortcuts: [Shortcut(modifiers: [.option], keys: [])], prefix: "hold"),
                    ...
                    KeyboardFeature(name: "Jump to Previous Tab", shortcuts: [Shortcut(modifiers: [.option, .command], keys: [.left])]),
                    KeyboardFeature(name: "Jump to Next Tab", shortcuts: [Shortcut(modifiers: [.option, .command], keys: [.right])]),
