...
struct OmniboxV2TabsList: View {
    ...
    private func widthProvider(for containerGeometry: GeometryProxy) -> TabsWidthProvider {
        TabsWidthProvider(tabsCount: tabs.count, pinnedTabsCount: pinnedTabs().count,
                         ...
                         dragModel: dragModel, designV2: true)
    }
    ...
    private func renderTab(_ tab: BrowserTab, index: Int, selectedIndex: Int, isSingle: Bool,
        ...
        return HStack(spacing: 0) {
            ...
            OmniboxV2TabView(tab: tab, isSelected: selected, isPinned: tab.isPinned, isSingleTab: isSingle,
        ...
        .frame(height: OmniboxV2TabView.height)
        ...
        GeometryReader { geometry in
            ...
            ZStack(alignment: .leading) {
                ...
                if let currentTab = currentTab, isDraggingATab {
                    OmniboxV2TabView(tab: currentTab, isSelected: true, isPinned: dragModel.draggingOverPins, isSingleTab: hasSingleOtherTab, isDragging: true)
    ...
    private func updateDraggableWindowRect(with geometry: GeometryProxy?, tabsSections: TabsSections) {
        ...
        frame.origin.y = 12
        frame.size.height = OmniboxV2TabView.height
...
struct OmniboxV2TabsList_Previews: PreviewProvider {
    ...
    static var previews: some View {
        OmniboxV2TabsList(tabs: .constant([
