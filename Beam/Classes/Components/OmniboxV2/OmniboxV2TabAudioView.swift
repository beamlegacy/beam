...
struct OmniboxV2TabAudioView: View {
    ...
    var body: some View {
        OmniboxV2TabView.TabContentIcon(name: audioIsMuted ? "tabs-media_muted" : "tabs-media", action: action)
