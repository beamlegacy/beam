...
struct UserProfileMenu_Previews: PreviewProvider {
    static var previews: some View {
        UserProfileMenu(viewModel: PasswordManagerMenuViewModel(host: URL(string: "https://beamapp.co")!, userInfoStore: MockUserInformationsStore(), withPasswordGenerator: false), width: 220)
    }
}
...
struct UserProfileCell_Previews: PreviewProvider {
    static var previews: some View {
        UserProfileCell(viewModel: PasswordManagerMenuViewModel(host: URL(string: "https://beamapp.co")!, userInfoStore: MockUserInformationsStore(), withPasswordGenerator: false))
    }
}
