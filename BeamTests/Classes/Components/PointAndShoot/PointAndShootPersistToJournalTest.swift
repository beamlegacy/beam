...
class PointAndShootPersistToJournalTest: PointAndShootTest {
    ...
    func testSingleShootToNote() throws {
        ...
        // Add shoot to note
        let group2 = PointAndShoot.ShootGroup("id", [paragraphTarget], "placeholder string", page.url!.absoluteString)
    ...
    func testTwoShootsToTwoDifferentCards() throws {
        ...
        // Add shoot to note
        let group = PointAndShoot.ShootGroup("id", [paragraphTarget], "placeholder string", page.url!.absoluteString)
        let expectation = XCTestExpectation(description: "point and shoot addShootToNote")
        ...
        // Add shoot to note
        let group2 = PointAndShoot.ShootGroup("id", [paragraphTarget2], "placeholder string", page.url!.absoluteString)
