...
class PasswordManagerHelper: BaseView {
    ...
    func doesAutogeneratedPasswordPopupExist() -> Bool {
        return app/*@START_MENU_TOKEN@*/.staticTexts["Beam created a password for this site."]/*[[".dialogs.staticTexts[\"Beam created a password for this site.\"]",".staticTexts[\"Beam created a password for this site.\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.waitForExistence(timeout: BaseTest.minimumWaitTimeout)
    }
