...
class PasswordManagerHelper: BaseView {
    ...
    func doesAutofillPopupExist(login: String, timeout: Double = BaseTest.minimumWaitTimeout) -> Bool {
        return getAutofillPopupElement(login: login).waitForExistence(timeout: timeout)
    }
