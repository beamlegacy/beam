...
class OmniBoxUITestsHelper : BeamUITestsHelper {
    ...
    let autocompleteCreateNotePredicate = NSPredicate(format: "identifier CONTAINS '-createNote'")
    ...
    override init(_ app: XCUIApplication) {
        ...
        allAutocompleteResults = app.links.matching(self.autocompleteResultPredicate)
        super.init(app)
    }
