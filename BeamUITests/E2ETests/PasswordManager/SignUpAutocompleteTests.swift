...
class SignUpAutocompleteTests: BaseTest {
    ...
    func testUseAutogeneratedPassword() throws {
        try XCTSkipIf(true, "Blocked by wikipedia from scaleway servers. TBD - refactor using another website")
        ...
        let fieldValue1 = passwordField1.value as? String ?? nil
        let fieldValue2 = passwordField1.value as? String ?? nil
