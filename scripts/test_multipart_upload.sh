...
curl --trace-ascii test_multipart_upload.dump http://api.beam.lvh.me/graphql \
   ...
   -F operations='{"query":"mutation UpdateBeamObjects($beamObjects: [BeamObjectInput!]!, $largeFiles: [Upload!], $privateKey: String) {\n  updateBeamObjects(input: {beamObjectsInput: $beamObjects, largeFiles: $largeFiles, privateKey: $privateKey}) {\n    beamObjects {\n      id\n      checksum\n      type\n      data\n    }\n    errors {\n      objectid\n      path\n      message\n    }\n  }\n}\n","variables":{"largeFiles": [null, null], "beamObjects":[{"previousChecksum":"dcc4c6ad8c76d52a501a99a30883b1bbc7682a15d1e7704f2bbcf62d1b6d46c2","checksum":"dcc4c6ad8c76d52a501a99a30883b1bbc7682a15d1e7704f2bbcf62d1b6d46c2","createdAt":"2021-11-18T15:11:41.660Z","id":"295D94E1-E0DF-4ECA-93E6-8778984BCD58","privateKeySignature":"45cb7cb283d0b9ca64219bd0bc033c0fad461aaf6783d5be71eac2e772c3c828","type":"my_remote_object","updatedAt":"2021-11-18T15:11:41.660Z"}]},"operationName":"UpdateBeamObjects"}' \
	-F map='{ "1" : [ "variables.largeFiles.0" ], "2" : [ "variables.largeFiles.1" ] }' \
	-F 1='@foobar.enc' \
	-F 2='@foobar.enc' \
